...
const Footer = () => {
  return (
    <div className=''>
        <footer className="footer p-10 bg-base-200 text-base-content max-w-screen-2xl container mx-auto w-100 md:px-20 px-6 mt-2">
  <nav>
...
<footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
  <aside className="items-center grid-flow-col">
    ...
    <p>Alfahad Ansari <br/>Providing reliable tech since 2023</p>
  </aside> 
